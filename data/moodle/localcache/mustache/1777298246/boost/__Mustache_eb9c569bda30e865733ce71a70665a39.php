...
class __Mustache_eb9c569bda30e865733ce71a70665a39 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockB3a79f80943609dafe3e0fcc5a1baf0c'),
            ));
...
';
    ...
    public function blockB3a79f80943609dafe3e0fcc5a1baf0c($context)
    {
        $indent = $buffer = '';
